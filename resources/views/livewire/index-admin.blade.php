    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
      <div class="container-fluid">
        <div class="navbar-wrapper">
          ...
          <a class="navbar-brand" href="#pablo" style="font-weight: bold">Dashboard</a>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="card card-chart">
            <div class="card-header">
              ...
              <h4 class="card-title">Totale de demandeure  <br>de formation</h4>
              <div class="dropdown">
        ...
        <div class="col-lg-4">
          <div class="card card-chart">
            <div class="card-header">
              ...
              <h4 class="card-title">Totale de demandeure  <br>de promotion</h4>
              <div class="dropdown">
        ...
        <div class="col-lg-4 ">
          <div class="card card-chart">
            <div class="card-header">
              <h5 class="card-category"></h5>
              <h4 class="card-title">Totale de demandeure  <br>de Financement</h4>
              <div class="dropdown">
