        ...
        <div class="col-md-12">
          <div class="card modern-card">
            <div class="card-header">
              <h4 class="card-title">Validation Finale</h4>
              <p class="card-category">Liste des demandes vérifiées en attente de validation budgétaire</p>
            </div>
            <div class="card-body">
                    ...
                    <tr>
                      <td colspan="6" class="text-center py-5">
                        <div style="display: flex; flex-direction: column; align-items: center; color: #888;">
                          ...
                          <p style="font-size: 16px;">Aucune demande vérifiée</p>
                        </div>
                      </td>
                    </tr>
                    @endforelse
