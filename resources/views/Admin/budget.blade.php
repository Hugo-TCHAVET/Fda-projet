    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="#pablo" style="font-weight: bold">Attribution du Budget </a>
            </div>
                ...
                <div class="row">
                  <div class="col-md-12 pr-1">
                    <div class="form-group">
                      <label style="font-weight: bold">Budget à attribuer </label>
                      <input type="number" name="buget_prevu" class="form-control" id="" >
